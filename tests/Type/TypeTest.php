...
class TypeTest extends TestCase
{
    ...
    public function provideTypes()
    {
        return [
            ...
            [new ClassType(ExampleBInterface::class), 'ExampleBInterface'],
            [(new ClassType(ExampleBInterface::class))->setNullable(true), '?ExampleBInterface'],
            [new FloatType(), 'float'],
            ...
            [new IntersectionType([new ClassType(ExampleBInterface::class), new ClassType(ExampleAInterface::class)]), 'ExampleBInterface&ExampleAInterface'],
    ...
    {
        $this->file = new ClassFile(file_get_contents(__DIR__ . '/../Fixtures/ExampleClassTypes.php'));
